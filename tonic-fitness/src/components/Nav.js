  ...
  return (
    <nav id="nav-container">
      <header id="header">
        ...
        {/* First Ternary to display Login options if no user logged in or Welcome {name} if user is signed in */
          (!props.currentUser) ?
          (<section className="icons hide"></section>) :
        ...
        /* End of First Ternary */}

        {/* Second Ternary to display Login options if no user logged in or Welcome {name} if user is signed in */
          (!props.currentUser) ?
